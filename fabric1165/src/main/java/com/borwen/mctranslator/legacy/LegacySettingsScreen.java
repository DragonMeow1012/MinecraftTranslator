    ...
    @Override protected void init() {
        ...
        addButton(new Button(width / 2 + 3, 198, 152, 20,
                ...
                button -> { cfg.deliverChatTranslationsInOrder =
                    ...
                    init(minecraft, width, height); }));
        addButton(new Button(width / 2 - 155, height - 22, 100, 20, new TranslatableComponent("config.mctranslator.translations.export"),
                button -> LegacyTranslatorMod.translationFile(false)));
        addButton(new Button(width / 2 - 50, height - 22, 100, 20, new TranslatableComponent("config.mctranslator.translations.import"),
