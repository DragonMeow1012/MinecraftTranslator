...
public final class TranslationConfigScreen extends Screen {
    ...
    protected void init() {
        ...
        this.addRenderableWidget(com.borwen.mctranslator.fabric.LegacyButton.builder(chatDeliveryLabel(cfg), b -> {
        ...
        this.addRenderableWidget(com.borwen.mctranslator.fabric.LegacyButton.builder(new net.minecraft.network.chat.TranslatableComponent("config.mctranslator.translations.export"), b -> MctranslatorFabric.translationFile(false))
                .bounds(left + 0 * (fileWidth + 4), y, fileWidth, 18).build());
        this.addRenderableWidget(com.borwen.mctranslator.fabric.LegacyButton.builder(new net.minecraft.network.chat.TranslatableComponent("config.mctranslator.translations.import"), b -> MctranslatorFabric.translationFile(true))
    ...
    private static Component chatDeliveryLabel(TranslatorConfig cfg) {
        Component mode = new net.minecraft.network.chat.TranslatableComponent(cfg.deliverChatTranslationsInOrder
                ? "config.mctranslator.chat_delivery.ordered"
                : "config.mctranslator.chat_delivery.ready_first");
        return new net.minecraft.network.chat.TranslatableComponent("config.mctranslator.chat_delivery", mode);
    }
