...
$artifacts = @(
    [pscustomobject]@{ Loader = 'forge'; Label = 'Forge'; Minecraft = '1.12.2'; Source = 'forge1122\build\libs\mctranslator-1.0.6-Forge-1.12.2.jar'; Relative = 'forge/1.12.2/mctranslator-1.0.6-Forge-1.12.2.jar'; MetadataKind = 'forge1122'; MinecraftRange = '1.12.2'; MainClass = 'com.borwen.mctranslator.forgelegacy.MinecraftTranslatorForge' },
