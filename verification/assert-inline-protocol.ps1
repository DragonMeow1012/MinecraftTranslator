...
$thread = $requests | Where-Object method -eq 'thread/start' | Select-Object -First 1
$turn = $requests | Where-Object method -eq 'turn/start' | Select-Object -First 1
$unsubscribe = $requests | Where-Object method -eq 'thread/unsubscribe' | Select-Object -First 1
