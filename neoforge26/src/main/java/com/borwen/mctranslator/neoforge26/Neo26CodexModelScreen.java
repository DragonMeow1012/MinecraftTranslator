...
public final class Neo26CodexModelScreen extends OptionsSubScreen {
    private ModelSelectionList modelList;
    private EditBox search;

    public Neo26CodexModelScreen(Screen parent) {
    ...
    private void choose(ModelOption option) {
        ...
        Neo26AiScreen.normalizeEffort(cfg, option);
    ...
    private final class ModelSelectionList
        ...
        private ModelSelectionList(Minecraft minecraft) {
            super(minecraft, Neo26CodexModelScreen.this.width,
                    Neo26CodexModelScreen.this.height - 33 - 36, 33, 18);
            filterEntries("");
        }
        ...
        private void selectCurrent() {
            String active = MctranslatorNeoForge26.config().codexModel;
        ...
        private final class Entry extends ObjectSelectionList.Entry<Entry> {
            ...
            public void extractContent(GuiGraphicsExtractor graphics, int mouseX, int mouseY,
                ...
                graphics.centeredText(Neo26CodexModelScreen.this.font, this.label,
