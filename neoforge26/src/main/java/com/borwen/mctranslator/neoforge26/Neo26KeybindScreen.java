...
public final class Neo26KeybindScreen extends Screen {
    ...
    protected void init() {
        ...
        int y = 44;
        int step = 24;
        y = rebind("screen.mctranslator.keybind.mode", MctranslatorNeoForge26.modeKeyMapping(), x, y, step);
        y = rebind("screen.mctranslator.keybind.retranslate", MctranslatorNeoForge26.retranslateKeyMapping(), x, y, step);
        y = rebind("screen.mctranslator.keybind.screenscan", MctranslatorNeoForge26.screenScanKeyMapping(), x, y, step);
        y = rebind("screen.mctranslator.keybind.toggle", MctranslatorNeoForge26.toggleKeyMapping(), x, y, step);
        y += 8;
